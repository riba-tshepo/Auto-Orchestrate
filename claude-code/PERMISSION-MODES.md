...
Claude Code operates in different permission modes that affect tool availability and agent behavior. This document provides a compatibility matrix for all 17 agents (1 pipeline-core + 4 pipeline + 12 team) and 48 skills across permission modes.

**Gap Status**: GAP-MED-002 MEDIUM
**Created**: 2026-02-11 (Iteration 2 remediation)
**Last updated**: 2026-04-26 — synced with parallel Stage 3 (PARALLEL-001/002/003) and 6-phase token-budget optimization suite
